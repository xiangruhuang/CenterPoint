...
class SimpleTextLoggerHook(LoggerHook):
    def __init__(self, interval=10, ignore_last=True, reset_flag=False):
        super(SimpleTextLoggerHook, self).__init__(interval, ignore_last, reset_flag)
        self.time_sec_tot = 0

    def before_run(self, trainer):
        super(SimpleTextLoggerHook, self).before_run(trainer)
    ...
    def _log_info(self, log_dict, trainer):
        ...
        try:
            if trainer.world_size > 1:
                class_names = trainer.model.module.class_names
            else:
                class_names = trainer.model.class_names
